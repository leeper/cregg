...
#' 
#' Note: cregg currently only works with full factorial conjoint experiments. Designs involving constraints between features may be supported in the future.
#' 
#' @examples
#' \dontrun{
#' # load data
